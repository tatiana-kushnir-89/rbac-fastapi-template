...
def read_users(
    session: SessionDep, current_user: AdminOrManager, skip: int = 0, limit: int = 100
) -> Any:
    """
...
def create_user(
    *, session: SessionDep, current_user: AdminUser, user_in: UserCreate
) -> Any:
    """
...
def read_user_by_id(
    ...
    Own profile: any role. Other profiles: admin or manager only.
    """
